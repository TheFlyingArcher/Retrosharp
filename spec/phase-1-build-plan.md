...
**Remaining**: the two API endpoints + routing + compose volume; `BulkGameEventImportSagaTests` + `EventFileArchive`/`BulkImportFailureNotifier` tests; live end-to-end verification.
