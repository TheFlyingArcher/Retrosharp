...
**Remaining**: `BulkGameEventImportSaga`; the `OnMessageSentToErrorQueue` hook; the two API endpoints + routing + compose volume; bulk-saga tests; live end-to-end verification.
