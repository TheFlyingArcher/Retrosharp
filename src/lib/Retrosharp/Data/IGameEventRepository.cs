...
namespace Retrosharp.Data
{
    ...
    /// GameEventFieldingCredit). See spec/game-event.md, "Data Model", and
    /// spec/phase-1-build-plan.md Step 6b.
    /// </summary>
    public interface IGameEventRepository
    {
        /// <summary>
        /// Inserts a batch of resolved games -- each with its full play/runner/fielding-credit
        /// graph -- as a single atomic transaction. A game already having any GameEvent rows is
        /// treated as fully processed and skipped whole, rather than upserted -- this is the
        /// game-level "already processed" check appropriate to Step 6b's scope; the stronger
        /// atomic claim needed to guard against two concurrent sagas racing on a shared game
        /// (GameEventGameStatus) is Step 6d's job.
        /// </summary>
